...
public class CodeGeneratorController {
    ...
    public ResponseEntity<Resource> generate(@RequestBody MetadataDto metadataDto) throws IOException {
        ...
        metadataDto.openAPIUrl = "https://raw.githubusercontent.com/openapitools/openapi-generator/master/modules/openapi-generator/src/test/resources/3_0/petstore.yaml";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<MetadataDto> requestEntity = new HttpEntity<>(metadataDto, headers);
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8080/api/gen/servers/java", requestEntity, String.class);
